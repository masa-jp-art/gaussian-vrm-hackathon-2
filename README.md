# gaussian-vrm-hackathon-2
Something I created at the Gaussian VRM hackathon.

gaussian vrm（ https://github.com/naruya/gaussian-vrm ）でアバターを作ってみんなで踊れるアプリケーションを作ろうとしました。
...
実写3Dアバター技術 ガウシアンVRMハッカソン https://3davatar.peatix.com/
